...
// SlicesIndex takes a slice of any comparable type 
// and an element of that type and returns the index 
// of the first occurrence of v in s, or -1 if not present. 
// The comparable constraint means that we can compare 
...
// We can define methods on generic types just 
// like we do on regular types, but we have to 
// keep the type parameters in place. 
...
func main() {
	...
	// for S and E when calling SlicesIndex - the compiler 
